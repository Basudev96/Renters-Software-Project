...
public class AddRenter extends javax.swing.JFrame {
    ...
    private void getEntries() {
        try {
            ...
            ResultSet rs = d.st.executeQuery("select * from rooms where vacant_bed>0 order by floor");
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        r.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(n, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(p, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(r, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
                                            .addComponent(s, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {a, fn, n, p, r, s});
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {a, fn, g1, g2, jLabel1, jLabel2, jLabel3, jLabel4, jLabel5, n, p});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel6, jLabel7, jLabel8, jLabel9, r, s, sd});
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (ri != -1) {
            try {
                ...
                if (dt!=null && !name.equals("") && !phone.equals("") && !fname.equals("") && !aadhar.equals("") && !address.equals("") && !r.getText().equals("") && !s.getText().equals("")) {
                    ...
                    db.DbConnect d = new db.DbConnect();
                    d.st.executeUpdate("insert into renters (name, phone, fname, gender, aadhar, address, room_no, rent, security, start_date, status) values('" + name + "','" + phone + "','" + fname + "','" + gender + "','" + aadhar + "','" + address + "','" + rn + "'," + rent + "," + security + ",'" + sdate + "','Active')");
                    d.st.executeUpdate("update rooms set vacant_bed=vacant_bed-1 where room_no='" + rn + "'");
