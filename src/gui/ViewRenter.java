...
public class ViewRenter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Phone", "F. Name", "Room No.", "Room Rent", "Address", "Gender", "Aadhar", "Start Date", "End Date", "Status"
            }
        ) {
    ...
    private void nKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nKeyReleased
        try {
            String name = n.getText();
            db.DbConnect d = new DbConnect();
            ResultSet rs = d.st.executeQuery("select * from renters where name like '%" + name + "%'");
            javax.swing.table.DefaultTableModel dtm = (javax.swing.table.DefaultTableModel) jTable1.getModel();
            //to remove rows in table
            int rc = dtm.getRowCount();
            while (rc-- != 0) {
