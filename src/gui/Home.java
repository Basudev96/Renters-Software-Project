...
public class Home extends javax.swing.JFrame {
    ...
    private void getEntriesJTable1(){
        try {
            ...
            db.DbConnect d = new DbConnect();
            ResultSet rs = d.st.executeQuery("select * from renters where name like '%" + name + "%' and status='active'");
    ...
    private void getEntries() {
        try {
            ...
            if (ri != -1) {
                ...
                db.DbConnect d = new DbConnect();
                ResultSet rs = d.st.executeQuery("select * from payments where renter_id =" + r_id + " order by payment_date DESC ");
                while (rs.next()) {
                    java.util.Vector row = new java.util.Vector();
    ...
    private void initComponents() {
        ...
        y.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        y.setText("2021");
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(y, javax.swing.GroupLayout.DEFAULT_SIZE, 81, Short.MAX_VALUE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(m, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(y, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {a, jLabel3, jLabel4, jLabel5, m, p, y});
    ...
    private void nKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_nKeyTyped
        commoncode.Validation.onlyAlphabateAllowed(evt);
        ...
        try {
            ...
            if (ri != -1) {
                if (p.getDate() != null && !y.getText().equals("") && !a.getText().equals("")) {
                    ...
                    db.DbConnect d = new DbConnect();
                    d.st.executeUpdate("insert into payments (renter_id,month,amount,payment_date) values(" + r_id + ",'" + month + "'," + amount + ",'" + pdate + "')");
                    getEntries();
        ...
        try {
            ...
            if (ri1 != -1 && ri2 != -1) {
                ...
                if (r == JOptionPane.YES_OPTION) {
                    ...
                    db.DbConnect d = new DbConnect();
                    d.st.executeUpdate("delete from payments where payment_id=" + p_id);
                    getEntries();
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        JOptionPane.showMessageDialog(null, "Design & Develop By: Basudev Sharma!");
        ...
        try {
            ...
            if (ri != -1) {
                ...
                if (r == JOptionPane.YES_OPTION) {
                    ...
                    db.DbConnect d = new DbConnect();
                    d.st.executeUpdate("update renters set status='Deactive' , end_date=CURRENT_DATE where renter_id="+r_id);
                    d.st.executeUpdate("update rooms set vacant_bed=vacant_bed+1 where room_no='"+room_no+"'");
                    getEntriesJTable1();
        ...
        try{
                ...
                if (ri != -1) {
                    if (p.getDate() != null && !y.getText().equals("") && !a.getText().equals("")) {
                        ...
                        PdfWriter.getInstance(d,new FileOutputStream("C:\\Users\\user\\Dropbox (Old)\\My PC (DESKTOP-HICR6U3)\\Downloads\\Documents"+r_id+"-"+name+"-"+month+".pdf"));
                        d.open();
                        d.add(new Paragraph("Renters App",FontFactory.getFont(FontFactory.TIMES_BOLD,18,Font.BOLD, Color.RED)));
